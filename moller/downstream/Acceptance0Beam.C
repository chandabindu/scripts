...
string1<<Form("/lustre19/expphy/volatile/halla/parity/chandan/sim_out/DSConfig0Shield0_beam/remollout_beam%d.root",ij);
...
TFile f("Acceptance_Config0Shield0_beam.root","RECREATE");
set_plot_style();
