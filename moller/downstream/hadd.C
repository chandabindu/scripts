...
void hadd() {
   ...
   FileList->Add( TFile::Open(Form("/lustre19/expphy/volatile/halla/parity/chandan/sim_out/OffsetCoilNoShld_ep/output/analysis_%d.root",ij)) );
   //FileList->Add( TFile::Open("/lustre19/expphy/volatile/halla/moller12gev/chandan/sim_out/OffsetCoil3_ep/output/analysis_2.root") );
   }
