...
int ShiftedCoil_BoreVsAcceptance(TString source, TString out)
{
TChain T("T");
...
std::map<int,string> snDet  {{63,"afterCol4"},{73,"At3p9M"},{76,"At4p4M"},{64,"beforeCoil1"},{65,"afterCoil1"},{66,"afterCoil2"},{72,"beforeLintel"},{74,"At14M"},{75,"At14p5M"},{78,"At15M"},{67,"At15p5M"},{71,"At15p8M"},{77,"At16p5M"},{68,"beforeCollar"},{69,"driftRegion"},{28,"maindet"}};
string sDet[nDet] = {"afterCol4","At3p9M","At4p4M","beforeCoil1","afterCoil1","afterCoil2","beforeLintel","At14M","At14p5M","At15M","At15p5M","At15p8M","At16p5M","beforeCollar","driftRegion","maindet"};
...
for(Int_t k=0;k<nDet;k++){
 for(Int_t i=0;i<nParticle;i++){
  ...
  h_d_xy[part] = new TH2D(part+"_d_xy",Form("No cut %s %s for %s",sEnergy[j].c_str(),sParticle[i].c_str(),sDet[k].c_str()),200,-1000, 1000, 200,-1000,1000);
  h_d1_xy[part] = new TH2D(part+"_d1_xy",Form("Maindet all %s %s for %s",sEnergy[j].c_str(),sParticle[i].c_str(),sDet[k].c_str()),120,-600, 600, 120,-600,600);
  h_d2_xy[part] = new TH2D(part+"_d2_xy",Form("Maindet from col4 bore %s %s for %s",sEnergy[j].c_str(),sParticle[i].c_str(),sDet[k].c_str()),400,-200, 200, 400,-200,200);
  h_d3_xy[part] = new TH2D(part+"_d3_xy",Form("Ring 5 all %s %s for %s",sEnergy[j].c_str(),sParticle[i].c_str(),sDet[k].c_str()),120,-600, 600, 120,-600,600);
  h_d4_xy[part] = new TH2D(part+"_d4_xy",Form("Ring 5 from col4 bore %s %s for %s",sEnergy[j].c_str(),sParticle[i].c_str(),sDet[k].c_str()),40,-200, 200, 40,-200,200);
  h_d_re[part] = new TH2D(part+"_d_re",Form("No cut %s %s for %s",sEnergy[j].c_str(),sParticle[i].c_str(),sDet[k].c_str()),120,0, 12000, 250,0,1250);
  h_d1_re[part] = new TH2D(part+"_d1_re",Form("Maindet all %s %s for %s",sEnergy[j].c_str(),sParticle[i].c_str(),sDet[k].c_str()),120,0, 12000, 120,0,600);
  h_d2_re[part] = new TH2D(part+"_d2_re",Form("Maindet from col4 bore %s %s for %s",sEnergy[j].c_str(),sParticle[i].c_str(),sDet[k].c_str()),120,0, 12000, 40,0,200);
  h_d3_re[part] = new TH2D(part+"_d3_re",Form("Ring 5 all %s %s for %s",sEnergy[j].c_str(),sParticle[i].c_str(),sDet[k].c_str()),120,0, 12000, 120,0,600);
  h_d4_re[part] = new TH2D(part+"_d4_re",Form("Ring 5 col4 bore %s %s for %s",sEnergy[j].c_str(),sParticle[i].c_str(),sDet[k].c_str()),120,0, 12000, 40,0,200);
  ...
  h_d_xy[part] = new TH2D(part+"_d_xy",Form("No cut %s %s for %s",sEnergy[j].c_str(),sParticle[i].c_str(),sDet[k].c_str()),130,-650, 650, 130,-650,650);
  h_d1_xy[part] = new TH2D(part+"_d1_xy",Form("Maindet all %s %s for %s",sEnergy[j].c_str(),sParticle[i].c_str(),sDet[k].c_str()),130,-650, 650, 130,-650,650);
  h_d2_xy[part] = new TH2D(part+"_d2_xy",Form("Maindet from col4 bore %s %s for %s",sEnergy[j].c_str(),sParticle[i].c_str(),sDet[k].c_str()),140,-700, 700, 140,-700,700);
  h_d3_xy[part] = new TH2D(part+"_d3_xy",Form("Ring 5 all %s %s for %s",sEnergy[j].c_str(),sParticle[i].c_str(),sDet[k].c_str()),130,-650, 650, 130,-650,650);
  h_d4_xy[part] = new TH2D(part+"_d4_xy",Form("Ring 5 from col4 bore %s %s for %s",sEnergy[j].c_str(),sParticle[i].c_str(),sDet[k].c_str()),60,-300, 300, 60,-300,300);
  h_d_re[part] = new TH2D(part+"_d_re",Form("No cut %s %s for %s",sEnergy[j].c_str(),sParticle[i].c_str(),sDet[k].c_str()),120,0, 12000, 120,50,650);
  h_d1_re[part] = new TH2D(part+"_d1_re",Form("Maindet all %s %s for %s",sEnergy[j].c_str(),sParticle[i].c_str(),sDet[k].c_str()),120,0, 12000, 120,50,650);
  h_d2_re[part] = new TH2D(part+"_d2_re",Form("Maindet from col4 bore %s %s for %s",sEnergy[j].c_str(),sParticle[i].c_str(),sDet[k].c_str()),120,0, 12000, 120,50,650);
  h_d3_re[part] = new TH2D(part+"_d3_re",Form("Ring 5 all %s %s for %s",sEnergy[j].c_str(),sParticle[i].c_str(),sDet[k].c_str()),120,0, 12000, 120,50,650);
  h_d4_re[part] = new TH2D(part+"_d4_re",Form("Ring 5 from col4 bore %s %s for %s",sEnergy[j].c_str(),sParticle[i].c_str(),sDet[k].c_str()),120,0, 12000, 120,50,650);
  h_d_r[part] = new TH1D(part+"_d_r",Form("No cut %s %s for %s",sEnergy[j].c_str(),sParticle[i].c_str(),sDet[k].c_str()), 1500,0,1500);
  ...
  h_d_xy[part] = new TH2D(part+"_d_xy",Form("No cut %s %s for %s",sEnergy[j].c_str(),sParticle[i].c_str(),sDet[k].c_str()),200,-1000, 1000, 200,-1000,1000);
  h_d1_xy[part] = new TH2D(part+"_d1_xy",Form("Maindet all %s %s for %s",sEnergy[j].c_str(),sParticle[i].c_str(),sDet[k].c_str()),200,-1000, 1000, 200,-1000,1000);
  h_d2_xy[part] = new TH2D(part+"_d2_xy",Form("Maindet from col4 bore %s %s for %s",sEnergy[j].c_str(),sParticle[i].c_str(),sDet[k].c_str()),100,-500, 500, 100,-500,1000);
  h_d3_xy[part] = new TH2D(part+"_d3_xy",Form("Ring 5 all %s %s for %s",sEnergy[j].c_str(),sParticle[i].c_str(),sDet[k].c_str()),1000,-1000, 1000, 1000,-1000,1000);
  h_d4_xy[part] = new TH2D(part+"_d4_xy",Form("Ring 5 from col4 bore %s %s for %s",sEnergy[j].c_str(),sParticle[i].c_str(),sDet[k].c_str()),100,-500, 500, 100,-500,1000);
  h_d_re[part] = new TH2D(part+"_d_re",Form("No cut %s %s for %s",sEnergy[j].c_str(),sParticle[i].c_str(),sDet[k].c_str()),120,0, 12000, 160,200,1000);
  h_d1_re[part] = new TH2D(part+"_d1_re",Form("Maindet all %s %s for %s",sEnergy[j].c_str(),sParticle[i].c_str(),sDet[k].c_str()),120,0, 12000, 160,200,1000);
  h_d2_re[part] = new TH2D(part+"_d2_re",Form("Maindet from col4 bore %s %s for %s",sEnergy[j].c_str(),sParticle[i].c_str(),sDet[k].c_str()),120,0, 12000, 160,200,1000);
  h_d3_re[part] = new TH2D(part+"_d3_re",Form("Ring 5 all %s %s for %s",sEnergy[j].c_str(),sParticle[i].c_str(),sDet[k].c_str()),120,0, 12000, 160,200,1000);
  h_d4_re[part] = new TH2D(part+"_d4_re",Form("Ring 5 from col4 bore %s %s for %s",sEnergy[j].c_str(),sParticle[i].c_str(),sDet[k].c_str()),120,0, 12000, 160,200,1000);
  h_d_r[part] = new TH1D(part+"_d_r",Form("No cut %s %s for %s",sEnergy[j].c_str(),sParticle[i].c_str(),sDet[k].c_str()), 800,200,1000);
  h_d1_r[part] = new TH1D(part+"_d1_r",Form("Maindet all %s %s for %s",sEnergy[j].c_str(),sParticle[i].c_str(),sDet[k].c_str()), 800,200,1000);
  h_d2_r[part] = new TH1D(part+"_d2_r",Form("Maindet from col4 bore %s %s for %s",sEnergy[j].c_str(),sParticle[i].c_str(),sDet[k].c_str()), 800,200,1000);
  h_d3_r[part] = new TH1D(part+"_d3_r",Form("Ring 5 all %s %s for %s",sEnergy[j].c_str(),sParticle[i].c_str(),sDet[k].c_str()), 800,200,1000);
  h_d4_r[part] = new TH1D(part+"_d4_r",Form("Ring 5 from col4 bore %s %s for %s",sEnergy[j].c_str(),sParticle[i].c_str(),sDet[k].c_str()), 800,200,1000);}
  else if(k==15){
...
//for(size_t j=0;j<100;j++){
  ...
  //  std::cout<<"After Continue :: Event "<<j<<" hit "<<i<<" trid "<<trid<<" iterator find "<<*it<<std::endl;  
    ...
    if(((det>=57 && det<=78) || det==28 ) && pid==11 && hit.vz<=-3875){
